...
async function main() {
    ...
    await approveErc20(wethTokenAddress, lendingPool.address, '100000000000000000', deployer)
    console.log("Depositing WETH...")
    await lendingPool.deposit(wethTokenAddress, '100000000000000000', deployer, 0)
